...
public class OrderRestController {
    ...
    @Operation(summary = "Create a new restaurant order by a customer",
            responses = {
    ...
    public ResponseEntity<Map<String, String>> saveOder(@Valid @RequestBody OrderRequestDto orderRequestDto, @RequestHeader("Authorization") String token) {
